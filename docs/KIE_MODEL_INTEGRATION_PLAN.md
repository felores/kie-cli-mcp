...
- [x] Add Seedance 2.0 Mini. Superseded by Seedance 2.5.
- [x] Add Suno V5_5.
- [x] Add OmniHuman 1.5.
- [x] Add Gemini Omni.
...
3. **Seedance 2.0 Mini**: historical implementation. Seedance 2.5 now replaces it with the fixed `bytedance/seedance-2-5` model.
...
- [Seedance 2.5](https://docs.kie.ai/market/bytedance/seedance-2-5): `POST /api/v1/jobs/createTask`, model `bytedance/seedance-2-5`.
