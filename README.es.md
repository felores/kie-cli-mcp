...
- **Transporte OpenAI**: `@felores/kie-ai-openai-server`, un servidor HTTP local que expone modelos seleccionados de imagen y video mediante rutas con formato OpenAI. La versión 0.2 agrega descubrimiento de modelos y compatibilidad nativa con los formatos de imagen y presets de video de Infinite Canvas. Ver [`docs/openai-transport.md`](docs/openai-transport.md).
